...
class CallHistory:
    ...
    def register_outgoing_call(self, call: Call) -> None:
        ...
        our_month = call.time.month
        our_year = call.time.year
        our_tuple = (our_month, our_year)
        if our_tuple in self.outgoing_calls:
            self.outgoing_calls[our_tuple].append(call)
        else:
            self.outgoing_calls[our_tuple] = [call]
    ...
    def register_incoming_call(self, call: Call) -> None:
        ...
        our_year = call.time.year
        our_tuple = (our_month, our_year)
        if our_tuple in self.incoming_calls:
            self.incoming_calls[our_tuple].append(call)
        else:
            self.incoming_calls[our_tuple] = [call]
    # ----------------------------------------------------------
